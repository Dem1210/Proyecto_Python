...
class Interfaz(tk.Tk):
    ...
    def agregar_usuario(self):
        ...
        self.telefono_entry = tk.Entry(ventana_agregar)
        self.telefono_entry.grid(row=3, column=1)

        agregar_btn = tk.Button(
            ventana_agregar, text="Agregar", command=self.guardar_usuario)
    ...
    def guardar_usuario(self):
        ...
        self.enviar_mensaje_bienvenida(nuevo_usuario)
